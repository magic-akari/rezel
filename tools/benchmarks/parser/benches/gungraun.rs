...
#[bench::php_10kb(rezel::setup(Language::Php, Tier::Kb10))]
#[bench::php_50kb(rezel::setup(Language::Php, Tier::Kb50))]
#[bench::php_100kb(rezel::setup(Language::Php, Tier::Kb100))]
#[bench::php_500kb(rezel::setup(Language::Php, Tier::Kb500))]
...
#[bench::php_10kb(tree_sitter::setup(Language::Php, Tier::Kb10))]
#[bench::php_50kb(tree_sitter::setup(Language::Php, Tier::Kb50))]
#[bench::php_100kb(tree_sitter::setup(Language::Php, Tier::Kb100))]
#[bench::php_500kb(tree_sitter::setup(Language::Php, Tier::Kb500))]
