...
static STATES: &[u32] = &[
    ...
    589826, 0, 15, 0, 1, 0, 589827, 0, 0, 0, 0, 589829, 589829, 0, 0, 0, 0, 1245188,
    1245188, 0, 0, 0, 0, 1114114, 1114114, 0, 0, 0, 0, 1245189, 1245189,
];
static STATE_DATA: &[u16] = &[
    65535, 0, 7, 5, 0, 8, 3, 1, 65535, 0, 8, 7, 0, 65535, 0, 7, 5, 0, 8, 3, 9, 65535, 0,
];
static GOTO: &[u16] = &[
    6, 1, 1, 7, 11, 15, 21, 5, 2, 0, 1, 5, 3, 0, 1, 2, 1, 0, 3, 6, 1, 2, 8, 4, 5, 4, 0, 1,
];
...
static TOKEN_EDGES: &[rezel_lr::TokenEdge] = &[
    ...
    rezel_lr::TokenEdge::new(64, 65, 2),
];
