...
static GOTO: &[u16] = &[
    11, 1, 1, 1, 1, 12, 1, 1, 17, 1, 23, 12, 7, 3, 0, 1, 5, 2, 1, 0, 3, 6, 1, 2, 7, 5, 5,
    2, 0, 1,
];
static TOKEN_STATES: &[rezel_lr::TokenState] = &[
    ...
    rezel_lr::TokenState::new(65535, 2, 4, 1, 1),
    rezel_lr::TokenState::new(65535, 3, 5, 1, 1),
];
...
static TOKEN_EDGES: &[rezel_lr::TokenEdge] = &[
    ...
    rezel_lr::TokenEdge::new(49, 50, 3),
