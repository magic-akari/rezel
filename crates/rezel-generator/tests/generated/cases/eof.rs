...
struct GeneratedTables {
    ...
    token_eof: [rezel_lr::TokenEof; 1usize],
    dynamic_precedences: [rezel_lr::DynamicPrecedence; 0usize],
}
#[cfg(target_endian = "little")]
static TABLES_LE: GeneratedTables = rezel_lr::__private::include_value!("eof.le.bin");
#[cfg(target_endian = "big")]
static TABLES_BE: GeneratedTables = rezel_lr::__private::include_value!("eof.be.bin");
#[cfg(target_endian = "little")]
