...
static STATES: &[u32] = &[
    0, 2, 0, 1, 0, 0, 2, 2, 0, 1, 0, 0, 0, 0, 0, 0, 589828, 589828, 0, 0, 0, 0, 1245188,
    1245188,
];
static STATE_DATA: &[u16] = &[65535, 0, 2, 2, 0, 3, 2, 0, 65535, 0, 3, 2, 65535];
...
static TOKEN_STATES: &[rezel_lr::TokenState] = &[
    ...
    rezel_lr::TokenState::new(65535, 1, 1, 1, 0),
];
static TOKEN_ACCEPTS: &[rezel_lr::TokenAccept] = &[
    rezel_lr::TokenAccept::new(2, 65535),
    rezel_lr::TokenAccept::new(3, 65535),
];
static TOKEN_EDGES: &[rezel_lr::TokenEdge] = &[rezel_lr::TokenEdge::new(120, 121, 1)];
static TOKEN_EOF: &[rezel_lr::TokenEof] = &[rezel_lr::TokenEof::new(1, 2)];
