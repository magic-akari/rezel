...
struct GeneratedTables {
    ...
    local_token_1_states: [rezel_lr::TokenState; 2usize],
    local_token_1_accepts: [rezel_lr::TokenAccept; 1usize],
    local_token_1_edges: [rezel_lr::TokenEdge; 4usize],
