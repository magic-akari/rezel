...
static STATES: &[u32] = &[
    0, 2, 0, 1, 0, 0, 2, 2, 0, 1, 0, 0, 0, 0, 0, 0, 589829, 589829, 0, 0, 0, 0, 1245189,
    1245189,
];
static STATE_DATA: &[u16] = &[
    65535, 0, 2, 2, 0, 3, 2, 0, 4, 2, 0, 65535, 0, 4, 3, 65535,
];
...
static TOKEN_STATES: &[rezel_lr::TokenState] = &[
    ...
    rezel_lr::TokenState::new(65535, 1, 2, 1, 2),
...
static TOKEN_EDGES: &[rezel_lr::TokenEdge] = &[
    rezel_lr::TokenEdge::new(65, 66, 1),
    rezel_lr::TokenEdge::new(66, 67, 2),
    rezel_lr::TokenEdge::new(46, 47, 3),
    rezel_lr::TokenEdge::new(66, 67, 4),
];
