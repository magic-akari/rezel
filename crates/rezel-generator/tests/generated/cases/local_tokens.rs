...
struct GeneratedTables {
    states: [u32; 90usize],
    state_data: [u16; 43usize],
    goto: [u16; 37usize],
    token_states: [rezel_lr::TokenState; 5usize],
    token_accepts: [rezel_lr::TokenAccept; 3usize],
    token_edges: [rezel_lr::TokenEdge; 4usize],
    token_eof: [rezel_lr::TokenEof; 0usize],
    local_token_1_states: [rezel_lr::TokenState; 5usize],
    local_token_1_accepts: [rezel_lr::TokenAccept; 3usize],
    local_token_1_edges: [rezel_lr::TokenEdge; 5usize],
