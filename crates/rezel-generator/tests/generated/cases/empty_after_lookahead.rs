...
struct GeneratedTables {
    states: [u32; 84usize],
    state_data: [u16; 51usize],
    goto: [u16; 34usize],
    token_states: [rezel_lr::TokenState; 9usize],
    token_accepts: [rezel_lr::TokenAccept; 7usize],
    token_edges: [rezel_lr::TokenEdge; 37usize],
