...
static STATES: &[u32] = &[
    2, 2, 0, 1, 0, 0, 2, 2, 0, 1, 0, 0, 2, 7, 0, 1, 0, 589827, 0, 0, 0, 0, 1245187,
    1245187, 0, 0, 0, 0, 1114115, 1114115,
];
static STATE_DATA: &[u16] = &[65535, 0, 5, 2, 0, 65535, 0, 2, 4, 0, 65535, 0];
...
static TOKEN_EDGES: &[rezel_lr::TokenEdge] = &[
    rezel_lr::TokenEdge::new(44, 45, 1),
    rezel_lr::TokenEdge::new(69, 70, 2),
];
