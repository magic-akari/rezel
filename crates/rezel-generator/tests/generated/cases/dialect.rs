...
static STATES: &[u32] = &[
    0, 2, 0, 1, 0, 0, 2, 2, 0, 1, 0, 0, 0, 0, 0, 0, 589831, 589831, 0, 0, 0, 0, 589826,
    589826, 0, 0, 0, 0, 589828, 589828, 0, 0, 0, 0, 589830, 589830, 0, 0, 0, 0, 1245191,
    1245191,
];
static STATE_DATA: &[u16] = &[65535, 0, 3, 3, 0, 5, 4, 0, 9, 5, 0, 65535, 0];
static GOTO: &[u16] = &[8, 1, 1, 9, 1, 9, 1, 9, 13, 5, 2, 0, 1, 2, 1, 0, 3, 6, 1];
...
static TOKEN_EDGES: &[rezel_lr::TokenEdge] = &[
    ...
    rezel_lr::TokenEdge::new(99, 100, 3),
];
...
static DIALECT_TERMS_0: &[u16] = &[3];
static DIALECT_TERMS_1: &[u16] = &[5];
...
static DIALECTS: &[rezel_lr::DialectSpec] = &[
    rezel_lr::DialectSpec {
        name: "a",
        terms: DIALECT_TERMS_0,
    },
    rezel_lr::DialectSpec {
        name: "b",
        terms: DIALECT_TERMS_1,
    },
];
