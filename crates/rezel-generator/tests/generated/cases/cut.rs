...
struct GeneratedTables {
    states: [u32; 102usize],
    state_data: [u16; 67usize],
    goto: [u16; 36usize],
    token_states: [rezel_lr::TokenState; 7usize],
...
static TABLES_LE: GeneratedTables = rezel_lr::__private::include_value!("cut.le.bin");
#[cfg(target_endian = "big")]
static TABLES_BE: GeneratedTables = rezel_lr::__private::include_value!("cut.be.bin");
#[cfg(target_endian = "little")]
