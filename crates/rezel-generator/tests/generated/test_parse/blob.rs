...
static TABLES_LE: GeneratedTables = rezel_lr::__private::include_value!("blob.le.bin");
#[cfg(target_endian = "big")]
static TABLES_BE: GeneratedTables = rezel_lr::__private::include_value!("blob.be.bin");
#[cfg(target_endian = "little")]
