...
static TABLES_LE: GeneratedTables = rezel_lr::__private::include_value!("empty.le.bin");
#[cfg(target_endian = "big")]
static TABLES_BE: GeneratedTables = rezel_lr::__private::include_value!("empty.be.bin");
#[cfg(target_endian = "little")]
