...
struct GeneratedTables {
    states: [u32; 48usize],
    state_data: [u16; 32usize],
    goto: [u16; 21usize],
    token_states: [rezel_lr::TokenState; 4usize],
    token_accepts: [rezel_lr::TokenAccept; 3usize],
    token_edges: [rezel_lr::TokenEdge; 6usize],
    token_eof: [rezel_lr::TokenEof; 0usize],
    dynamic_precedences: [rezel_lr::DynamicPrecedence; 0usize],
}
#[cfg(target_endian = "little")]
static TABLES_LE: GeneratedTables = rezel_lr::__private::include_value!("parens.le.bin");
#[cfg(target_endian = "big")]
static TABLES_BE: GeneratedTables = rezel_lr::__private::include_value!("parens.be.bin");
#[cfg(target_endian = "little")]
