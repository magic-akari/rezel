...
struct GeneratedTables {
    states: [u32; 156usize],
    state_data: [u16; 141usize],
    goto: [u16; 72usize],
    token_states: [rezel_lr::TokenState; 10usize],
    token_accepts: [rezel_lr::TokenAccept; 9usize],
    token_edges: [rezel_lr::TokenEdge; 32usize],
    token_eof: [rezel_lr::TokenEof; 0usize],
    dynamic_precedences: [rezel_lr::DynamicPrecedence; 0usize],
}
#[cfg(target_endian = "little")]
static TABLES_LE: GeneratedTables = rezel_lr::__private::include_value!("parse.le.bin");
#[cfg(target_endian = "big")]
static TABLES_BE: GeneratedTables = rezel_lr::__private::include_value!("parse.be.bin");
#[cfg(target_endian = "little")]
