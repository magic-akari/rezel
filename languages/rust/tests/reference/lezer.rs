...
const CASE_SCHEMA: &str = "rezel.lezer-rust-reference-cases.v1";
const SNAPSHOT_SCHEMA: &str = "rezel.lezer-rust-reference-snapshot.v1";
const CASES: &str = include_str!("../../../../tools/references/lezer/cases/rust.json");
const SNAPSHOT: &str = include_str!("../../../../tools/references/lezer/snapshots/rust.json");
...
#[test]
fn valid_rust_csts_match_strict_and_recovering_lezer_parses() {
...
#[test]
fn invalid_rust_csts_match_deterministic_lezer_recovery() {
    let (cases, snapshot) = reference_data();
