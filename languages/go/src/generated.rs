...
struct GeneratedTables {
    states: [u32; 4020usize],
    state_data: [u16; 7242usize],
    goto: [u16; 2843usize],
    ...
    local_token_4_states: [rezel_lr::TokenState; 4usize],
    local_token_4_accepts: [rezel_lr::TokenAccept; 2usize],
    local_token_4_edges: [rezel_lr::TokenEdge; 3usize],
...
static TOKENIZERS: &[rezel_lr::Tokenizer] = &[
    ...
    rezel_lr::Tokenizer::External(&crate::tokens::INDEX_TYPE),
...
static TERM_NAMES: &[(u16, &str)] = &[
    ...
    (164u16, "\",\" type+"),
    (165u16, "\",\" Element+"),
    (166u16, "statement semi | \";\"+"),
    (167u16, "\",\" expr?+"),
    (168u16, "ConstSpec semi+"),
    (169u16, "\",\" typeName+"),
    (170u16, "\",\" TypeParam+"),
    (171u16, "TypeSpec semi+"),
    (172u16, "VarSpec semi+"),
    (173u16, "Case<exprList> semiSep<statement>+"),
    (174u16, "Case<commaSep1<type>> semiSep<statement>+"),
    (175u16, "Case<SendStatement | ReceiveStatement> semiSep<statement>+"),
    (176u16, "␄"),
    (177u16, "insertedSemi"),
    (178u16, "indexTypeStart"),
    (179u16, "%mainskip-1"),
    (180u16, "space"),
    (181u16, "\"/*\""),
    ...
    (193u16, "type-1"),
    (194u16, "\"*\""),
    (195u16, "commaSep<Parameter>-1"),
    (196u16, "typeElem-1"),
    (197u16, "typeOrUnderlying-1"),
    (198u16, "\"|\""),
    (199u16, "typeName-1"),
    (200u16, "commaSep1<type>-1"),
    (201u16, "commaSep<Element>-1"),
    (202u16, "semiSep<statement>-1"),
    (203u16, "\"+\""),
    (204u16, "\"-\""),
    (205u16, "\"!\""),
    (206u16, "\"^\""),
