...
`LRParser` directly. Packages that need input translation, preflight checks, or
strict post-parse validation provide one language-owned parse function without
narrowing the common parser surface.
